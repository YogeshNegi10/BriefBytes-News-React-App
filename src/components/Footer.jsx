...
const Footer = () => {
  return (
    <footer className="w-full bg-[#323232]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-6 flex justify-between items-center flex-col gap-8 lg:flex-row">
          <ul className="text-lg text-center sm:flex  gap-14 lg:gap-6 xl:gap-14 transition-all duration-500">
            <li>
              <a
                href="#"
                className="text-white hover:text-gray-400 mb-2 text-1xl"
              >
                "BriefBytes"
              </a>
            </li>
              ...
              <div className="flex items-center justify-center">
                <span className="text-gray-400 ">
                  ©<a href="#">BriefBytes</a>2024, All rights
                  reserved.
                </span>
